...
podeSalvar: () => {
    ...
    const descOriginal = TableRaca.selectedRow.raca001_desc || "";
    const tipoanimalOriginal = TableRaca.selectedRow.raca001_tipoanimal || "";
...
temAlteracao: () => {
    ...
    const descOriginal = (TableRaca.selectedRow?.raca001_desc || "").trim().toUpperCase();
    const tipoAnimalOriginal = TableRaca.selectedRow?.raca001_tipoanimal;
