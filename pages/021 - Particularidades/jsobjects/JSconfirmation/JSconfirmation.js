...
async executeAction() {
    ...
    const actionsMap = {
        "Insert": InsertParticuladirade,
        "Update": UpdateParticuladirade,
        "Delete": DeleteParticuladirade
    };
    ...
    if (targetQuery) {
        return targetQuery.run()
            .then(async () => {
                ...
                await Promise.all([SelectParticuladiradeCount.run(), SelectParticuladirade.run()]); 
