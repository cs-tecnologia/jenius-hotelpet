...
podeSalvar: () => {
    ...
    const descOriginal = TableAspectos.selectedRow.aspecto001_descricao || "";
    const tipoanimalOriginal = TableAspectos.selectedRow.aspecto001_tipoanimal || "";
...
temAlteracao: () => {
    ...
    const descOriginal = (TableAspectos.selectedRow?.aspecto001_descricao || "").trim().toUpperCase();
    const tipoAnimalOriginal = TableAspectos.selectedRow?.aspecto001_tipoanimal;
